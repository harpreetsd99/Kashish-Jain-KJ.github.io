...
docRef.get().then(function(doc) {
    if (doc.exists) {
        ...
        b.setAttribute("onclick","onclick="+"buy('"+doc.data()['Product_Name']+"')");
        ...
        if(count>0){
            ...
            for(i=1;i<=count;i++){
                ...
                console.log("x",x);
                $("#checkpoint").append(
                    `<div class = "cp" style=" min-width:${c-x}%;"><i class="fa fa-hand-scissors-o fa-rotate-270 " style="color:orange;" ></i></div><!--`
                );
                $("#cpqty").append(
            ...
            console.log("x",x);
            $("#bar").css("width",x+"%");
		    // $("#checkpoint-details").append($("#checkpoint").html());
            // for(i=1;i<=count;i++){
            //     a = "CheckPointQuantity" + i.toString();
            //     var b = "CheckPointPrice" + i.toString();
        ...
        //         $(".bullet1").css("left",a+"%");
        //         if(a1>=100){
        //             $(".bullet2").css("left",(a1-8)+"%");
        //             $("#label-price2").css("left",(a1-7)+"%");
        //             $("#label-qty2").css("left",(a1-8)+"%")
        //         }
        //         else{
        //             $(".bullet2").css("left",a1+"%");
        //             $("#label-price2").css("left",a1+"%");
        //             $("#label-qty2").css("left",(a1-1)+"%")
        //         }
        ...
        //         $("#label-qty3").css("left",(a2-12)+"%");
        //         $("#label-price4").css("left",(a3-14.3)+"%");
        //         $("#label-qty4").css("left",(a3-17.3)+"%");
        //         $("#label-price5").css("left",(a4-19)+"%");
        //         $("#label-qty5").css("left",(a4-24)+"%");
        //         $("#bar").css("width",b+"%");
        //         // Large-Mob-----------------------------------------
        //         var mq = window.matchMedia( "(max-width: 425px)" );
        //         if (mq.matches) {
